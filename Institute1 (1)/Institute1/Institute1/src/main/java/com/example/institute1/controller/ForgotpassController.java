...
import com.example.institute1.BO.ForgotBOImpl;
...
public class ForgotpassController implements Initializable {
    ...
    private final ForgotBOInterface forgotBO = new ForgotBOImpl();
    ...
    private void sendEmail(String to, String otp) throws MessagingException {
        final String FROM = System.getenv("EMAIL_USERNAME");
    ...
    private boolean isEmailRegistered(String email) {
        try {
            return forgotBO.isEmailRegistered(email);
        } catch (Exception e) {
            e.printStackTrace();
