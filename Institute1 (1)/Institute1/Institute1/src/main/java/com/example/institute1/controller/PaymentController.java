...
import com.example.institute1.BO.PaymentBOImpl;
...
public class PaymentController implements Initializable {
    PaymentBOImpl paymentBO = (PaymentBOImpl) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.PAYMENTBO);
    ...
    void paymentUpdate(ActionEvent event) {
        ...
        if (selectedPayment != null) {
            ...
            if (buttonType.get() == ButtonType.YES) {
                try {
                    if (paymentBO.updatePayment(updatedPaymentDto)) {
