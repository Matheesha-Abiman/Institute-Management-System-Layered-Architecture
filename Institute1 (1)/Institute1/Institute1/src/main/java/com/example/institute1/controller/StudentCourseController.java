...
import com.example.institute1.BO.Student_courseBOImpl;
...
public class StudentCourseController implements Initializable {
    ...
    Student_courseBOImpl studentCourseBO = (Student_courseBOImpl) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.STUDENT_COURSEBO);
    ...
    private void refreshTable() {
        try {
            List<StudentCourseDto> sCourses = studentCourseBO.getAllStudentCourses();
