...
import com.example.institute1.BO.AdminBOImpl;
import com.example.institute1.BO.BOFactory;
import com.example.institute1.BO.ParentBOImpl;
...
public class ParentController implements Initializable {
    ParentBOImpl parentBO = (ParentBOImpl) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.PARENTBO);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            refreshTable();
            lblParentId.setText(parentBO.getNextParentID());
    ...
    public void refreshTable() {
        try {
            List<ParentDto> parents = parentBO.getAllParents();
    ...
    void parentSave(ActionEvent event) {
        try {
            if (validateParentInputs()) {
                ...
                if (parentBO.saveParent(parentDto)) {
    ...
    void parentUpdate(ActionEvent event) {
        ...
        if (selectedParent != null) {
            ...
            if (buttonType.isPresent() && buttonType.get() == ButtonType.YES) {
                ...
                try {
                    if (parentBO.updateParent(updatedParentDto)) {
    ...
    void parentDelete(ActionEvent event) {
        ...
        if (selectedParent != null) {
            ...
            if (buttonType.isPresent() && buttonType.get() == ButtonType.YES) {
                try {
                    if (parentBO.deleteParent(selectedParent.getParentId())) {
