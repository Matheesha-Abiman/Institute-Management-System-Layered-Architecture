...
public class AdminController implements Initializable {
    AdminBOImpl adminBO = (AdminBOImpl) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.ADMINBO);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            refreshTable();
            lblAdminId.setText(adminBO.getNextAdminID());
    ...
    private void refreshTable() {
        try {
            List<AdminDto> admins = adminBO.getAllAdmins();
...
//AdminModel.updateAdmin(updatedAdminDto
                try {
                    if (adminBO.updateAdmin(updatedAdminDto)) {
    ...
    private void adminDelete(ActionEvent event) {
        ...
        if (selectedAdmin != null) {
            ...
            if (buttonType.isPresent() && buttonType.get() == ButtonType.YES) {
                try {
                    if (adminBO.deleteAdmin(selectedAdmin.getAdminId())) {
